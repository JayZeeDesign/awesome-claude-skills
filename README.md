...
- **claude-dash** - [claude-dash](https://github.com/krabat-l/claude-dash) - Real-time statusline plugin for Claude Code showing context health, quota, cost, cache efficiency, and tool activity
- **claude-dash** - [claude-dash](https://github.com/krabat-l/claude-dash) - Real-time statusline plugin for Claude Code showing context health, quota, cost, cache efficiency, and tool activity
